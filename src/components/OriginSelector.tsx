            ...
            >
              ...
              {onRemoveAddress && (
                <button
                  ...
                  className="absolute top-1/2 right-2 w-7 h-7 -translate-y-1/2 flex items-center justify-center rounded-full text-sm text-muted-foreground/60 hover:text-foreground hover:bg-muted/50 transition-colors opacity-50 md:opacity-0 md:group-hover:opacity-100"
